...
import styleEdit from './EditPost.module.scss'
        ...
        async function fetchPost() {
            try {
                ...
                setData({
                    ...
                    Tag: postData.Tag.map(tag => ({ id: tag.id })),
        ...
        <div className="container">
            <div className="row mt-5 text-white justify-content-center">
                ...
                <div className="col-8 text-white mb-5 d-flex justify-content-between align-items-center">
                    <h1 className="fw-bold flex-wrap w-75">You are editing:    {post.title}</h1>
                    <MdArrowBackIosNew className={`${styleEdit.buttons}`} onClick={handleBack} />
                </div>
                ...
                <div className="col-8 text-white pb-4">
                    <form onSubmit={handleSubmit} encType='multipart/form-data'>
                        ...
                        <div className="mb-3">
                            ...
                            <textarea
                                className={`${styleEdit.input} ${styleEdit.content_input}`}
                                id="content"
                                rows="10"
                                value={data.content}
